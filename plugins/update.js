// plugins/update.js
const { cmd } = require("../DianaTech"); // keeps your style consistent
...
async (conn, mek, m, { from, quoted, q, react, reply, isSuperUser, isOwner, setCommitHash, getCommitHash }) => {
  try {
    ...
    const repoOwner = "QUEEN-DIANA";
    const repoName = "QUEEN-LORA";
    const branch = "main";
    ...
    // ----- OVERRIDE DISPLAY -----
    const authorName = "dianadenzyy";          // always show popkid
    const authorEmail = "dianadenzyy@gmail.com"; // masked email
